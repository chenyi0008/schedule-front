	...
	<div>
		...
		<el-dialog title="普通规则" :visible.sync="dialogVisible" width="50%">
			<el-form ref="form" :model="form" label-width="80px">
				...
				<el-form-item>
					<el-button type="text" @click="open">提交预览</el-button>
		...
		>
			<el-form ref="form" :model="form" label-width="80px">
				...
				<el-form-item>
					<el-button type="primary" @click="addPostionRule()"
						>提交</el-button
					>
					<el-button @click="anotherdialogVisible = false"
						>取消</el-button
					>
				</el-form-item>
			</el-form>
		...
		>
			...
			<div slot="footer" class="dialog-footer">
				<el-button @click="ruleInfoDialogVisible = false"
					>取 消</el-button
				>
				<el-button type="primary" @click="submitRuleInfo">
					提 交
				</el-button>
			</div>
		</el-dialog>
